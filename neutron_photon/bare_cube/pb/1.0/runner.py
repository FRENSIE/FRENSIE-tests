...
if __name__ == "__main__":
    ...
    parser.add_option("--sim_name", type="string", dest="sim_name", default="sims",
    ...
    parser.add_option("--source_energy", type="float", dest="source_energy",default=0.8,
    ...
    Simulation( options.sim_name,
                ...
                Utility.doubleArrayFromString("{1e-9,1e-9,100l,100}"),
                options.threads,
                options.log_file )
