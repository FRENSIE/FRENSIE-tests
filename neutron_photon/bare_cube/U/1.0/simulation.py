...
##---------------------------------------------------------------------------##
    ...
    u238_definition = scattering_center_definitions.createDefinition( "U238", Data.ZAID(92238) )

    # Neutrons
    nuclide_properties = database.getNuclideProperties( Data.ZAID(92238) )
    u238_definition.setNuclearDataProperties(nuclide_properties.getSharedNuclearDataProperties(Data.NuclearDataProperties.ACE_FILE, 8, 293.6, False))
